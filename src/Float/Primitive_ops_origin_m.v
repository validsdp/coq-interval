...
Definition select_float10a (a b c d e f g h i j : PrimFloat.float) := a.
Definition select_float10b (a b c d e f g h i j : PrimFloat.float) := a.
Definition select_float11c (a b c d e f g h i j k : PrimFloat.float) := a.

Definition doubling' f (x y : PrimFloat.float) := (let r1 := (f x y) in
                          let r2 := (f x y) in
                          let r3 := (f x y) in
                          let r4 := (f x y) in
                          let r5 := (f x y) in
...
Definition doubling'' f (x y : PrimFloat.float) := (let r1 := (doubling' f x y) in
...
Definition add_UPn x y := next_up (x + y).

Definition add_DNn x y := next_down (x + y).

Definition sub_UPn x y := next_up (x - y).

Definition sub_DNn x y := next_down (x - y).

Definition mul_UPn x y := next_up (x * y).

Definition mul_DNn x y := next_down (x * y).

Definition div_UPn x y := next_up (x / y).

Definition div_DNn x y := next_down (x / y).

Definition sqrt_UPn x (_ : PrimFloat.float) := next_up (PrimFloat.sqrt x).

Definition sqrt_DNn x (_ : PrimFloat.float) := next_down (PrimFloat.sqrt x).
